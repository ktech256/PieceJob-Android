...
data class SettingsDto(
    ...
    val referralBaseUrl: String? = null,
    val isReferralProgramEnabled: Boolean = true,
    val qrBrandingType: String? = "NONE", // NONE, PIECEJOB, WORKSPACE
    val referralRewardType: String? = "REFERRAL_BALANCE",
    val referralCurrencyCode: String? = null,
    val referralMinCompletedJobs: Int = 1,
    val referralMaxRewardsPerUser: Int = 5,
    val referralRewardDelayDays: Int = 0,
    val referralExpiryDays: Int = 0,
    val referralFraudDuplicatePhoneEnabled: Boolean = true,
    val referralFraudDuplicateEmailEnabled: Boolean = true,
    val referralFraudHardwareDetectionEnabled: Boolean = true,
    val referralFraudCircularDetectionEnabled: Boolean = true,
    val bookingFee: Double,
